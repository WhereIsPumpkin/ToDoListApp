...
let tasks = [
    ...
    Task(taskName: "Task 5", date: "4 Oct", isDone: true, color: Color(red: 0.84, green: 0.94, blue: 1)),
    Task(taskName: "Task 6", date: "5 Oct", isDone: true, color: Color(red: 0.84, green: 0.94, blue: 1)),
]
